...
* What are data science problems?
  ...
  intelligence", [[kozyrkov_2019][Cassie Kozyrkov (2018)]]. She has a specific, business-
  ...
  data" ([[saklani_2017][Saklani, 2017]]) and "thick [qualitative, descriptive] data"
  may be just as good depending on what you want to know. The
  article by [[chiu_2020][Chiu (2020)]] is a bit of a history hack (in the
  ...
  ([[rohrer_2015][Rohrer, 2015a, 2015b, 2015c]]). His examples are a more specific,
  ...
  *...youR tuRn:* Think about any decision you make - what are the steps
  ...
  shown in the figure [[fig:decision]] - why (or why not)? [[challenge_decisions][(Hint)]]

  #+end_notes

** Data science applications
   [[../../img/1_overview/ds_applications.jpg]]
