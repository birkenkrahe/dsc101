...
* Week 14 - November 18
  ...
  | TODAY       | TOPIC                      | TIME |
  |-------------+----------------------------+------|
  | Lecture     | [[https://github.com/birkenkrahe/dsc101/tree/main/9_ggplot2][Working with ~ggplot2~]] 2   | 45'  |
  | Video (?)   | [[https://www.datanovia.com/en/blog/gganimate-how-to-create-plots-with-beautiful-animation-in-r/][Animating]] with ~gganimate~ |      |
  | Information | Test exam on Nov 23        |      |
