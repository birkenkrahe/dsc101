...
** R Data structures
   ...
   * DataCamp (doing [[https://www.datacamp.com/mobile#!][drills]]?)[fn:4]
...
[fn:4]Hopefully, you remember that you have to complete >50% of the
DataCamp assignments on time to pass the course. There are 15
assignments in total (so you need to complete 8 on time).
