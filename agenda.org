...
* Week 15 - November 23
  ...
  | TODAY          | TOPIC                      | TIME |
  |----------------+----------------------------+------|
  | [[https://app.datacamp.com/groups/data-science-methods-and-tools/assignments][DataCamp]]       | Deadline extended (Dec 3)  |      |
  | Evaluation     | Anonymous online form      | 20'  |
  | Lecture        | [[https://github.com/birkenkrahe/dsc101/tree/main/9_ggplot2][Working with ~ggplot2~]] 2   |      |
  | Instructions   | Presentation submissions   |      |
  | Video/Notebook | [[https://www.datanovia.com/en/blog/gganimate-how-to-create-plots-with-beautiful-animation-in-r/][Animating]] with ~gganimate~ |      |
