...
* Week 15 - November 23
  ...
  | TODAY       | TOPIC                      | TIME |
  |-------------+----------------------------+------|
  | Lecture     | [[https://github.com/birkenkrahe/dsc101/tree/main/9_ggplot2][Working with ~ggplot2~]] 2   | 15'  |
  | Video (?)   | [[https://www.datanovia.com/en/blog/gganimate-how-to-create-plots-with-beautiful-animation-in-r/][Animating]] with ~gganimate~ | 30'  |
  | Information | Submissions and final exam | 30'  |
