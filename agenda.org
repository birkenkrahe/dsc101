...
* Week 13 - November 11
  ...
  | Lecture      | Working with ~ggplot2~ (1) | 30'  |
...
* Week 14 - November 16
  ...
  | TODAY    | TOPIC                      | TIME |
  |----------+----------------------------+------|
  | Test     | Plotting with base R       | 15'  |
  | Lecture  | Working with ~ggplot2~     | 30'  |
  | Practice | Practicing with ~ggplot2~  | 30'  |
  | Lecture  | [[https://www.datanovia.com/en/blog/gganimate-how-to-create-plots-with-beautiful-animation-in-r/][Animating]] with ~gganimate~ |      |
...
* Week 14 - November 18
  ...
  | TODAY       | TOPIC                      | TIME |
  |-------------+----------------------------+------|
  | Practice    | [[https://www.datanovia.com/en/blog/gganimate-how-to-create-plots-with-beautiful-animation-in-r/][Animating]] with ~gganimate~ |      |
  | Information | Text exam on Nov 23        |      |
