...
1.  [What is this?](#org4f794c5)
2.  [Redrawing Google trend chart (07-13-2021)](#orge9b0ba1)
    1.  [The original from `trends.google.com`](#orgafb3a13)
    2.  [Recreated trends from raw data](#orgbc08eaa)
        1.  [Scatterplot](#org9ea4340)
        2.  [Barplot](#orge851d48)
    3.  [Scatterplot code](#orge977e91)
        1.  [Download dataset as `csv` file](#org804415c)
        2.  [Upload as data frame using `read.table`](#org595cb07)
        3.  [Create line plot](#org344fb31)
    4.  [Barplot   code](#orgfeb4f0c)
    5.  [Code summary](#orge359fc7)
3.  [Data science process (07-15-2021)](#orgb385343)
4.  ["Teaching the tidyverse in 2021" (09-07-2021)](#org21b3950)
5.  [Data or graph checking projects (10-07-2021)](#org06d8a1b)
6.  [From the sickbed (11-02-2021)](#org9d79a47)
    1.  [Webscraping example](#org4345b60)
    2.  [New CRAN packages](#org8947052)
    3.  ["Tidyverse" twitter tidbit](#orgde2f8c5)
    4.  [The battle between Python and R has been concluded](#orgbad9ed5)
7.  [Good-bye (12-17-2021)](#org33a0fd1)
    1.  [What does it all mean?](#org8d178ff)
    2.  [What about the class? Choices and changes.](#org3a0d386)
    3.  [What next? Follow-up courses.](#orgc24e420)
    4.  [Final words.](#org4c3adb9)
8.  [References](#orgb821348)
...
developed the model shown in figure [22](#org30062ed): there are two pathways
...
clients (see figure [25](#org57160b0)).
...
[27](#org10ea606)), from a recent book on data analytics<sup><a id="fnr.2" class="footref" href="#fn.2">2</a></sup>. I really like
...
([Cetinkaya-Rundel, 2021](#orgd27cd8f)), which upset me. I will briefly explain
...
started with doing data science in R." ([Cetinkaya-Rundel, 2020](#orgef82a94)).
...
2021](#org1144dab)). It's a very good piece of work, created with a lot of effort
...
interesting, by [Matloff (2021)](#org16fcc78). This highly opinionated data
...
Source: [Rauenbusch J (2021)](#org07cf6e6).
...
Comment by [Norman Matloff](#org24cbd72) on Twitter about this tweet:
...
[introductory blog post](https://www.datacamp.com/community/tutorials/data-table-cheat-sheet) for starters ([Willems, 2021](#org1247278)).
...
2021](#orgb7183b5)) is spot on - there's no need to pitch one of these languages
...
are turned into sound ([Wilke 2021](#orgb3e9e94)).
...
essay), writes ([Matloff, 2021](#org2753ea5)):
...
<a id="org1144dab"></a> Cai Y, Otlu C, Rauenbusch J (28 June 2021). Improve
...
<a id="orgef82a94"></a> Cetinkaya-Rundel M (13 Jul 2020). Teaching the Tidyverse
...
<a id="orgd27cd8f"></a> Cetinkaya-Rundel M (31 Aug 2021). Teaching the Tidyverse
in 2021 [Blog]. [Online: tidyverse.org.](https://www.tidyverse.org/blog/2021/08/teach-tidyverse-2021/)

<a id="org24cbd72"></a> Matloff N (2020). TidyverseSceptic - An alternate view
...
<a id="org16fcc78"></a> Matloff N (9 Sept 2021). At Crossroads in California
...
<a id="org2753ea5"></a> Matloff N (2021). The (Academically) Rich Get Richer, the
...
<a id="org07cf6e6"></a> Rauenbusch J (2021). Design in MBA Education in the
...
<a id="orgb7183b5"></a> Valdeleon J (29 Aug 2021). The battle between Python & R
has been concluded [blog]. URL: [medium.com](https://medium.com/codex/the-battle-between-python-r-has-been-concluded-b6ffda4ef87).

<a id="orgb3e9e94"></a> Wilke U (29 Oct 2021). The Chaos Machine - Synthesizing
...
<a id="org1247278"></a> Willems K (July 14th, 2021). The data.table R Package
