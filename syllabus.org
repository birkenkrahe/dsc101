...
*** DataCamp assignments (15%)
    ...
    LinkedIn - see [[https://www.linkedin.com/in/birkenkrahe][my LinkedIn profile]] for an example). Your DataCamp
...
** Schedule and session content
   ...
   |--------+-------------------------+------------------------------|
   | 17-Aug | *Course overview*       | [[https://learn.datacamp.com/courses/free-introduction-to-r][Introduction to R:]]           |
   | 19-Aug | *Data science overview* | - Intro to basics            |
   | 24-Aug | *The R shell*           | - Vectors                    |
   | 26-Aug | *The R environment*     | - Matrices                   |
   | 31-Aug | *Vectors*               | - Factors                    |
   | 2-Sep  | *Data frames*           | - Data frames                |
   | 7-Sep  | *Factor vectors*        | - Lists                      |
   | 9-Sep  | *Lists in R*            | [[https://learn.datacamp.com/courses/intermediate-r][Intermediate R]]:              |
   | 14-Sep | *~Nile~ exploration*    | - Conditionals               |
   | 16-Sep | *Visualization*         | - Loops                      |
   | 21-Sep | *Base R graphics*       | - Functions                  |
   | 23-Sep | Writing functions       | - The ~apply~ family         |
   | 28-Sep | Iteration I             | - Utilities                  |
   | 30-Sep | Fibonacci series        |                              |
   | 7-Oct  | *Literate Programming*  | [[https://learn.datacamp.com/courses/data-visualization-in-r][Data Visualization:]]          |
   ...
   | 26-Oct | Packages                |                              |
   | 28-Oct | Grammar of Graphics     | [[https://learn.datacamp.com/courses/introduction-to-regression-in-r][Regression in R]]:             |
   ...
   | 18-Nov | Coding style            | [[https://learn.datacamp.com/courses/text-mining-with-bag-of-words-in-r][Text mining (Bag-of-Words)]]   |
