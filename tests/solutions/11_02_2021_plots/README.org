#+OPTIONS: toc:nil
* Upload your solution for the "[[https://github.com/birkenkrahe/dsc101/blob/main/tests/problems/different_plots_problems.ipynb][different plot types notebook]]" here as a notebook file!
